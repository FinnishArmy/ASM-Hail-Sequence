...
#Ask the user for an integer
	...
	move $s4, $s1	   # This is the current iterations.
...
mainLoop:
	...
	andi $t1, $s4, 1   
	beq $t1, $zero, evenFunction #If t1 is equal to 0, branch to even function.
...
oddLoop:
	add $s2, $s2, $s1  # Add itself 3 times to multiply by 3
